  ...
  return (
    <>
      <div className="fixed w-full text-white p-2 lg:hidden">
        ...
        {menuVisible && (
          <div className="mt-2 bg-yellow-400 flex rounded-b-2xl flex-col justify-center items-center">
            ...
            <Link href="/Contact">
              <div className="my-1 font-bold text-white border-b-2 text-lg duration-200 hover:scale-105 py-2">
                Contact
              </div>
            </Link>
            <Link href="/Gallery">
      ...
      <div className="top-[26vh] fixed hidden lg:block">
        <Link href="/Course-Outline">
          <div className="hover:translate-x-2 my-2 transition transform duration-400 ease-in-out font-bold duration-200 gap-1 flex text-lg justify-end items-end w-16 bg-yellow-500 py-8 rounded-r-lg">
